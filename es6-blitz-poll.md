...
## 17. Определить  temporal dead zone  (временную мертвую зону) в ES6.
...
## 18. Что такое `spread` -параметр распространения, `default` - по умолчанию и `rest` параметры?
...
## 19. Что такое `classes` и `proxies`?
...
## 20. Когда я должен использовать функции стрелки в ES6?
...
## 21. Когда НЕ следует использовать функции стрелок в ES6? Назовите три или более случаев.
...
## 22. Объясните разницу между `Object.freeze ()` и `const`.
...
## 23. Объясните Prototype Design Pattern.
